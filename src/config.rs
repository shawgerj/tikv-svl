...
impl Default for DefaultCfConfig {
    fn default() -> DefaultCfConfig {
        ...
        DefaultCfConfig {
            ...
            write_buffer_size: ReadableSize::mb(4),
            max_write_buffer_number: 5,
            min_write_buffer_number_to_merge: 1,
            max_bytes_for_level_base: ReadableSize::mb(16),
            target_file_size_base: ReadableSize::mb(2),
            ...
            compaction_guard_min_output_file_size: ReadableSize::mb(2),
...
impl Default for RaftCfConfig {
    fn default() -> RaftCfConfig {
        ...
        RaftCfConfig {
            ...
            max_write_buffer_number: 5,
            min_write_buffer_number_to_merge: 1,
            max_bytes_for_level_base: ReadableSize::mb(32),
            target_file_size_base: ReadableSize::mb(4),
            level0_file_num_compaction_trigger: 1,
            level0_slowdown_writes_trigger: None,
            level0_stop_writes_trigger: None,
            max_compaction_bytes: ReadableSize::gb(2),
